...
Het beheer van deze kritieke infrastructuur komt echter in het gedrang door de 'silver tsunami': ervaren Mainframe-ontwikkelaars gaan massaal met pensioen, 
...
Gamification, het strategisch inzetten van spelmechanismen zoals beloningssystemen, leaderboards en levels in een niet-spelcontext kan hiervoor een oplossing bieden.
...
Er is ook een populair framework dat specifiek kijkt naar de psychologische drijfveren achter deze gamedesign-elementen: het \textit{Octalysis-framework}, ontwikkeld door \textcite{Chou2015}. 
...
Het framework is opgebouwd rond acht fundamentele motivaties, de zogenaamde \textit{Core Drives}. 
...
De evaluatie vindt plaats via een \textit{mixed-methods} aanpak: kwantitatieve data wordt verzameld via de \textit{System Usability Scale (SUS)} voor gebruiksvriendelijkheid, terwijl kwalitatieve inzichten worden verkregen via een semi-gestructureerd interview of survey over de ervaren motivatie.
...
\begin{itemize}
    \item \textbf{Studenten zonder voorkennis:} De verwachting is dat gamificatie-elementen de drempelvrees voor de verouderde COBOL-syntax verlaagt.
...
Dit onderzoek toont aan of moderne leermethodieken (gamificatie) ingezet kunnen worden om legacy-systemen aantrekkelijk te maken voor een nieuwe generatie ontwikkelaars.