...
\title{Gamification voor het aanleren van COBOL}
...
\projectrepo{https://bap-cobol-gamification.vercel.app/}
...
\emph{Boodschap: COBOL blijft kritieke en groeiende infrastructuur, maar de kennisoverdracht naar een nieuwe generatie moet evolueren.}
...
\emph{Boodschap: levels worden sequentieel ontgrendeld, zodat beginners de programmaskelet beheersen voor ze complexere concepten zien.}

%------------------------------------------------------------------------------
\subsection{Gamification per Octalysis Core Drive}

\small
\begin{tabularx}{\linewidth}{@{}>{\bfseries}p{6.2cm} X@{}}
\toprule
...
\normalsize
Het ontwerp is bewust \textit{White Hat}-zwaar: het mikt op positieve, langetermijnmotivatie en zet schaarste en verliesangst spaarzaam in \autocite{Chou2015}.
