...
\begin{description}[leftmargin=3.5cm,labelwidth=3cm,style=nextline,font=\bfseries]
    ...
    \item[RLS]      Row-Level Security, rij-gebaseerde toegangscontrole.
    \item[SMD]      Standardised Mean Difference, gestandaardiseerd gemiddeld verschil.
    \item[SUS]      System Usability Scale, tien-item Likert-vragenlijst voor de bruikbaarheid van een systeem.
