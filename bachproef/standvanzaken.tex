...
\begin{lstlisting}[language=Cobol, caption={Conditional in COBOL}, label={lst:cobol_loop}]
...
\subsection{Bouwstenen van Gamification}
...
\section{hoe Effectiviteit meten} %TODO