...
Om gamification efficiënt toe te passen, worden specifieke bouwstenen uit games geïsoleerd en geïmplementeerd. 
...
Om een diepere betrokkenheid te creëren, identificeert het Octalysis-model acht fundamentele \textit{Core Drives} (zie figuur \ref{fig:octalysis}):
